...
$SSH_CMD "
    # Step 1: Comment out conflicting directives in main sshd_config
    ...
    echo 'Commented out conflicting directives in /etc/ssh/sshd_config'
...
# Date: $(date +%Y-%m-%d)
# 
# NOTE: This is the ONLY active config. All conflicting directives in 
# /etc/ssh/sshd_config and /etc/ssh/sshd_config.d/*.conf have been disabled.
