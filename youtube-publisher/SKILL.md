...
setup: "./SETUP.md"
changelog:
  - 2026-06-27: v1.4.0 (a) youtube-upload.ts: subtitle/thumbnail failures now exit with rc=2 and structured SUBTITLES_UPLOADED/THUMBNAIL_UPLOADED markers instead of silent console.error; (b) new --subtitles-only mode with --video-id for uploading subtitles to an existing video; (c) Upload Summary block for pipeline parsing. v1.3.0: proxy support + Premature close retry.
